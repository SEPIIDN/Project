...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2023 at 12:36 PM
...
(2, 'random', '1c6637a8f2e1f75e06ff9984894d6bd16a3a36a9');
...
CREATE TABLE `messages` (
  ...
  `message` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `products` (
  `id` int(100) NOT NULL,
  `name` varchar(100) NOT NULL,
  `details` varchar(500) CHARACTER SET utf32 COLLATE utf32_general_ci NOT NULL,
  `price` int(10) NOT NULL,
...
(1, 'SEPIDN', 'sepehrdehnamaki@gmail.com', '2b9c7dff746b80d07a952be03211c96ccd4c2881');
